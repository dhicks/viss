...
::: {.landscape}
![Distribution of responses to VISS items, ordered by total agreement.  Vertical dashed lines indicate 20%, 50%, and 80%. *[ggpattern]*](img/03_likert.png){#fig-03-likert}
:::
