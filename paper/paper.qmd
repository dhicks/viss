...
*[format change: 
- turn off toc
- checkmarks showing up? 
- bib entry formatting
- cutoff for word count
...
- abstract, keywords
- longtable? 
    - when using a label (w/ or w/o a caption), the entire chunk output is wrapped in a `table` environment, which causes the `longtable` to be confined to a single page
