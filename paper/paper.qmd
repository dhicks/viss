...
acknowledgments: "For feedback on this project, thanks to participants at the 10th Annual Values in Medicine, Science, and Technology Conference at UT Dallas, May 2022, and the Knowledge, Science, and Society conference at UC San Diego, May 2024. In particular, thanks to Magdalena Grohman for suggesting the qualitative approach used in study 2.  Thanks to UC Merced for funding to support EJCL, CC, and JD throughout different stages of this project, and for the survey studies."
...
# Background and initial development of VISS items {.unnumbered}
...
To our knowledge, the only empirical studies of public views on the value-free ideal (VFI) are @ElliottValuesEnvironmentalResearch2017 and @HicksValuesDisclosuresTrust2022, the latter of which is a replication and re-analysis of the former.  In an online survey experiment, @HicksValuesDisclosuresTrust2022 found that disclosing public health values might increase, rather than decrease, trust in the disclosing scientist, conflicting with many claims that VFI supports trust.  
...
For this study, items were arranged into 3 blocks of 5-7 items each, roughly corresponding to latent variables identified in the study 1 EFA.  In Qualtrics, we prepared a survey in which participants were randomly allocated to a single block.  Participants were presented with the item text, a 5-point agree/disagree Likert scale, and a free text response box. As we were primarily interested, at this stage, in assessing how participants understood the VISS items, between the first and second iterations of data collection the Likert scale was expanded from a 5-point to a 7-point scale in an attempt to facilitate more nuanced comprehension of the items.  They were instructed to "Please indicate how much you agree with each of the following statements. Then, in the text box, please write a few sentences explaining why you answered the way you did." 
...
### Individual item analysis {.unnumbered}
...
### The value-free ideal {.unnumbered}
...
### VISS factors and trust {.unnumbered}
...
## The value-free ideal and its critiques {.unnumbered}
...
## Values in science and generalized trust {.unnumbered}
...
The distribution of responses to individual items — e.g., acceptance of the value-free ideal — was of key interest in this study.  For the sake of space, we defer this analysis to study 3, which used the finalized, construct validated VISS items.  @suppfig-desc-comb compares rates of agreement ("somewhat agree" or more) for all VISS items across studies 1 and 3.  
